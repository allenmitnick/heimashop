...
<body>
	...
	<div class="container">
		...
		<div>
			<hr />
			<form id="orderForm"
				action="${pageContext.request.contextPath }/payOrder.order"
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="address"
							value="${order.address }" name="address" placeholder="请输入收货地址">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="name"
							value="${order.name }" name="name" placeholder="请输收货人">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="telephone"
							value="${order.telephone }" name="" placeholder="请输入联系方式">
					</div>
				</div>
