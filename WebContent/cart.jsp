		...
		<div class="container">
				...
				<div style="margin: 0 auto; margin-top: 10px; width: 950px;">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<c:forEach items="${cart.orderItems }" var="entry">
								<tr class="active">
									...
									<td width="10%">${entry.value.count }</td>
									<td width="15%"><span class="subtotal">￥${entry.value.subTotal }</span>
									</td>
									
									<td><a href="${pageContext.request.contextPath }/delFromCart.cart?pid=${entry.value.product.pid}"
			...
			<div style="margin-right: 130px;">
				...
				<div
					...
					<a href="${pageContext.request.contextPath }/clearCart.cart" id="clear" class="clear">清空购物车</a> <a
						href="${pageContext.request.contextPath }/saveOrder.order"> <input type="submit" width="100"
